...
export const mockBearNotes: BearNote[] = [
  {
    ...
    ZCREATIONDATE: MockCoreDataUtils.fromDate(new Date('2024-01-01T10:00:00Z')),
    ZMODIFICATIONDATE: MockCoreDataUtils.fromDate(new Date('2024-01-01T10:30:00Z')),
    ZTRASHED: 0,
    ZARCHIVED: 0,
    ZPINNED: 0,
    ZENCRYPTED: 0,
  ...
  },
  {
    ...
    ZCREATIONDATE: MockCoreDataUtils.fromDate(new Date('2023-12-01T15:00:00Z')),
    ZMODIFICATIONDATE: MockCoreDataUtils.fromDate(new Date('2023-12-01T15:15:00Z')),
    ZTRASHED: 0,
    ZARCHIVED: 1,
    ZPINNED: 0,
    ZENCRYPTED: 0,
    ZORDER: null,
    ZTRASHEDDATE: null,
    ZARCHIVEDDATE: MockCoreDataUtils.fromDate(new Date('2023-12-15T09:00:00Z')),
  },
  {
    Z_PK: 3,
    ZTITLE: 'Trashed Note',
    ZTEXT: '# Trashed Note\n\nThis note is in trash.\n\n#trash',
    ZCREATIONDATE: MockCoreDataUtils.fromDate(new Date('2023-11-01T12:00:00Z')),
    ZMODIFICATIONDATE: MockCoreDataUtils.fromDate(new Date('2023-11-01T12:05:00Z')),
    ZTRASHED: 1,
    ZARCHIVED: 0,
    ZPINNED: 0,
    ZENCRYPTED: 0,
    ZORDER: null,
    ZTRASHEDDATE: MockCoreDataUtils.fromDate(new Date('2023-11-15T14:00:00Z')),
    ZARCHIVEDDATE: null,
  },
  {
    Z_PK: 4,
    ...
    ZCREATIONDATE: MockCoreDataUtils.fromDate(new Date('2024-01-15T08:00:00Z')),
    ZMODIFICATIONDATE: MockCoreDataUtils.fromDate(new Date('2024-01-15T08:30:00Z')),
    ZTRASHED: 0,
    ZARCHIVED: 0,
    ZPINNED: 1,
    ZENCRYPTED: 0,
  ...
  },
  {
    ...
    ZCREATIONDATE: MockCoreDataUtils.fromDate(new Date('2024-01-20T16:00:00Z')),
    ZMODIFICATIONDATE: MockCoreDataUtils.fromDate(new Date('2024-01-20T16:05:00Z')),
    ZTRASHED: 0,
    ZARCHIVED: 0,
    ZPINNED: 0,
    ZENCRYPTED: 0,
...
export const mockBearTags: BearTag[] = [
  {
    ...
    ZORDER: null,
    ZCREATIONDATE: MockCoreDataUtils.fromDate(new Date('2024-01-01T10:00:00Z')),
    ZMODIFICATIONDATE: MockCoreDataUtils.fromDate(new Date('2024-01-01T10:00:00Z')),
  },
  {
    Z_PK: 2,
    ZTITLE: 'sample',
  ...
  },
  {
    ...
    ZORDER: null,
    ZCREATIONDATE: MockCoreDataUtils.fromDate(new Date('2023-12-01T15:00:00Z')),
    ZMODIFICATIONDATE: MockCoreDataUtils.fromDate(new Date('2023-12-01T15:00:00Z')),
  },
  {
    Z_PK: 4,
    ZTITLE: 'important',
    ...
    ZORDER: null,
    ZCREATIONDATE: MockCoreDataUtils.fromDate(new Date('2024-01-15T08:00:00Z')),
    ZMODIFICATIONDATE: MockCoreDataUtils.fromDate(new Date('2024-01-15T08:00:00Z')),
  },
  {
    Z_PK: 5,
    ...
    ZPARENT: null,
    ZORDER: null,
    ZCREATIONDATE: MockCoreDataUtils.fromDate(new Date('2024-01-10T09:00:00Z')),
    ZMODIFICATIONDATE: MockCoreDataUtils.fromDate(new Date('2024-01-10T09:00:00Z')),
  },
];
